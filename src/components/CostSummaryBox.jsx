...
const CostSummaryBox = ({ job, materials = [], labour = [], expenses = [] }) => {
  ...
  // Payments table not yet implemented — show zero for now
  const totalPaid = 0;
                ...
                <div key={idx} className="py-3 flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {m.quantity} {m.unit || 'units'} × {formatCurrency(m.unit_cost)}
                    </p>
                  </div>
              ...
              lab.map((l, idx) => (
                <div key={idx} className="py-3 flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {formatDate(l.work_date)} — {getLabourDisplay(l)}
                    </p>
                  </div>
